...
![пр 6 запрос для 4 пункта](https://github.com/user-attachments/assets/30948301-922f-4802-98de-9f6b7fcc023a)


## 5. Загрузим данные в pandas и построим гистограмму распределения, используя my_data.plot.hist(y='public_transportation_pct').
```python
try:
    connection = get_connection("pr6")
...
![пр 6 гистограмма](https://github.com/user-attachments/assets/fc0d744f-fcd5-4c85-9c4e-a63b09d34d22)


## 6. Сгруппируем клиентов по их zip_code и посмотрим на среднее количество транзакций на одного клиента. Затем экспортируем эти данные в Excel и создадим диаграмму рассеяния, чтобы лучше понять взаимосвязь между использованием общественного транспорта и продажами.
...
![пр  6 пункт 6](https://github.com/user-attachments/assets/56797b63-3427-499e-b912-a33bdbea3e6d)
